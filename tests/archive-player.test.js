...
assert.match(css, /@media \(max-width:\s*767px\)[^]*\.painter-archive__wear\s*\{[^}]*background:#fff/s);
assert.match(css, /@media \(max-width:\s*767px\)[^]*\.painter-archive__wear\s*\{[^}]*border:1px solid rgba\(17,17,17,\.14\)/s);
assert.match(css, /@media \(max-width:\s*767px\)[^]*\.painter-archive__wear\s*\{[^}]*padding:8px/s);
