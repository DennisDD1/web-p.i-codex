	...
	(function () {
		...
		function hideLegacyPromotionSections() {
			document.querySelectorAll('section').forEach(function (section) {
				...
				if ((text.indexOf('30% OFF SITEWIDE') !== -1 || text.indexOf('50% OFF SITEWIDE') !== -1 || text.indexOf('70% OFF SITEWIDE') !== -1) && text.indexOf('Latest Promotions') !== -1) {
...
add_action( 'wp_body_open', function () {
	...
	?>
		<div class="painter-offer-bar" role="note" aria-label="Current offer">
			...
			<span>New Arrival Sale</span>
			<strong>70% Off Sitewide</strong>
			<em>Free shipping over $4.89</em>
		</div>
	<script>
	(function () {
